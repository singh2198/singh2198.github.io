...
const About = () => {
  return (
    ...
    <div
    id="about" className="about section" name="about"
      
    >
      <div  className=" flex flex-col justify-center mx-auto w-full h-full p-4 max-w-screen-lg"  >
        <div style={{paddingBottom:"1px"}}  >
          <h3  style={{fontSize:"2.25rem",lineHeight:"7.5rem", fontWeight:700,color:"white" }}  >About </h3>
        </div>

        <div id="user-detail-intro">
        <p className="  text-gray-400  sm:py-3 w-full" >
