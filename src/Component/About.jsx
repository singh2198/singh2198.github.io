...
const About = () => {
    return (
        <div name="About Me" className='w-full  bg-gradient-to-b from-gray-700 to-gray-800 text-white'>
            <div className=' flex flex-col justify-center mx-auto w-full h-full p-4 max-w-screen-lg'>
                ...
                <div className='pb-8'>
                    ...
                    <p className=" mt-1 text-gray-400 py-0 sm:py-3 w-full">Aspiring Full Stack MERN Developer,
                                        enthusiastic to learn and explore new
                                        technologies
                                        Journey with Masai is awesome ,35 weeks of coding
                                        experiance and learn lots of things,Completed
